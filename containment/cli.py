...
class Profile:
    def __init__(self):
        ...
        self.package_list = ["vim", "tmux", "git"] # These are examples.
...
class Context:
    def __init__(self, cli):
        ...
        self.dockergid =\
            subprocess.getoutput("grep docker /etc/group").split(':')[2]
        # CONFIGURATION STRINGS
        self.project_adapter = \
        f"""RUN     useradd -G docker --uid {self.userid} --home /home/{self.user} {self.user}
        ...
        self.externalbasis = ("ubuntu@sha256:c8c275751219dadad8fa56b3ac41ca6cb22219ff117ca9"
                         "8fe82b42f24e1ba64e")
...
class Command_Line_Interface:
    def __init__(self):
        ...
        self.pkg_install_cmds = {"debian":   "apt-get install -y",
    ...
    def pave_profile(self):
        ...
        json.dump(
            self.profile.package_list,
            self.profile.os_packages.open(mode='w')
        )
        json.dump(
            {},
            self.profile.lang_packages.open(mode='w')
        )
